...
INSERT INTO `t_article` VALUES ('17', '1', 'java提高篇-----详解java的四舍五入与保留位', '<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\">四舍五入其实在金融方面运用的非常多，尤其是银行的利息。我们都知道银行的盈利渠道主要是利息差，它从储户手里收集资金，然后放贷出去，期间产生的利息差就是银行所获得的利润。如果我们采用平常四舍五入的规则话，这里采用每10笔存款利息计算作为模型，如下：</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 四舍：0.000、0.001、0.002、0.003、0.004。这些舍的都是银行赚的钱。</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 五入：0.005、0.006、0.007、0.008、0.009。这些入的都是银行亏的钱，分别为：0.005、0.004、.003、0.002、0.001。</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 所以对于银行来说它的盈利应该是0.000 + 0.001 + 0.002 + 0.003 + 0.004 - 0.005 - 0.004 - 0.003 - 0.002 - 0.001 = -0.005。从结果中可以看出每10笔的利息银行可能就会损失0.005元，千万别小看这个数字，这对于银行来说就是一笔非常大的损失。面对这个问题就产生了如下的银行家涉入法了。该<a href=\"http://lib.csdn.net/base/datastructure\" class=\"replace_word\" title=\"算法与数据结构知识库\" target=\"_blank\" style=\"text-decoration:none;color:#DF3434;font-weight:bold;\">算法</a>是由美国银行家提出了，主要用于修正采用上面四舍五入规则而产生的误差。如下：</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 舍去位的数值小于5时，直接舍去。</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 舍去位的数值大于5时，进位后舍去。</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 当舍去位的数值等于5时，若5后面还有其他非0数值，则进位后舍去，若5后面是0时，则根据5前一位数的奇偶性来判断，奇数进位，偶数舍去。</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 对于上面的规则我们举例说明</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 11.556 = 11.56 ------六入</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 11.554 = 11.55 -----四舍</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 11.5551 = 11.56 -----五后有数进位</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 11.545 = 11.54 -----五后无数，若前位为偶数应舍去</span> \r\n</p>\r\n<p style=\"margin-top:0px;margin-bottom:0px;padding:0px;color:#555555;font-family:\'microsoft yahei\';font-size:15px;line-height:35px;white-space:normal;background-color:#FFFFFF;\">\r\n	<span style=\"font-size:18px;\"> 11.555 = 11.56 -----五后无数，若前位为奇数应进位</span> \r\n</p>', '', 'java提高篇-----详解java的四舍五入与保留位', '2016-06-20 15:38:07', '29', '四舍五入其实在金融方面运用的非常多，尤其是银行的利息。我们都知道银行的盈利渠道主要是利息差，它从储户手里收集资金，然后放贷出去，期间产生的利息差就是银行所获得的利润。如果我们采用平常四舍五入的规则话，这里采用每10笔存款利息计算作为模型，如下：', '1', 'y');
INSERT INTO `t_article` VALUES ('18', '4', 'sss', '<a class=\"ke-insertfile\" href=\"/attached/file/20191116/20191116113552_821.xlsx\" target=\"_blank\">tttt</a>ssss<img src=\"data:image/png;base64,\" alt=\"\" />', '/attached/image/20191116/20191116113012_955.jpg', 'ssss', '2019-11-16 11:30:26', '8', 'sss', '0', 'y');
INSERT INTO `t_article` VALUES ('19', '4', 'yyyy', 'hhhhhhhhhhhhhhhhhhhhhhhhhhhmmmmmmmmmmmmmmmmmmmmmmm', '/attached/image/20191116/20191116165000_301.jpg', 'hhh', '2019-11-16 16:50:10', '0', 'hhh', '0', 'y');
...
INSERT INTO `t_articlecategory` VALUES ('3', 'sss', 'ssss', 'c', '3');
INSERT INTO `t_articlecategory` VALUES ('4', '滚滚滚', 'ss', 'c', '11');
...
-- ----------------------------
INSERT INTO `t_contact` VALUES ('5', '<span style=\"white-space:normal;\">地址：河南省新郑市薛店镇S102省道与中华北路交叉口</span> \r\n<p style=\"white-space:normal;\">\r\n	电话：400-691-9999\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	邮箱：haoxiangni1992@haoxiangni.cn\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	<br />\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	<br />\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	<iframe src=\"http://localhost:8080/resource/kindeditor/plugins/baidumap/index.html?center=113.763141%2C34.516801&zoom=18&width=558&height=360&markers=113.763141%2C34.516801&markerStyles=l%2CA\" frameborder=\"0\" style=\"width:560px;height:362px;\">\r\n	</iframe>\r\n</p>');
...
-- ----------------------------
INSERT INTO `t_indeximg` VALUES ('25', '4', '/attached/image/20191123/20191123101701_477.jpg', '4', '#', 'y');
INSERT INTO `t_indeximg` VALUES ('26', '2', '/attached/image/20191123/20191123101806_829.jpg', '1', '#', 'y');
...
INSERT INTO `t_messages` VALUES ('54', 'rr', 'm', '反反复复', '17600181925', '9875253371@qq.com', 'rrr', '2019-11-16 11:32:31');
...
-- ----------------------------
INSERT INTO `t_service` VALUES ('1', '别墅装修', '公司的最新新闻在此发布hhh', 'y', '2');
INSERT INTO `t_service` VALUES ('2', '小区装修', '小区装修小区装修小区装修小区hhhh', 'y', '1');
INSERT INTO `t_service` VALUES ('3', 'xxxx', 'eeeehhh', 'y', '3');
...
INSERT INTO `t_systemlog` VALUES ('439', 'login', 'login', '1', 'admin', '127.0.0.1', '2019-11-16 11:29:29', null, 'n');
INSERT INTO `t_systemlog` VALUES ('440', 'login', 'login', '1', 'admin', '0:0:0:0:0:0:0:1', '2019-11-16 13:34:05', '0', 'y');
INSERT INTO `t_systemlog` VALUES ('441', 'login', 'login', '1', 'admin', '127.0.0.1', '2019-11-16 14:05:22', null, 'n');
INSERT INTO `t_systemlog` VALUES ('442', 'login', 'login', '1', 'admin', '127.0.0.1', '2019-11-16 16:33:04', null, 'n');
INSERT INTO `t_systemlog` VALUES ('443', 'login', 'login', '1', 'admin', '127.0.0.1', '2019-11-16 16:49:15', null, 'n');
INSERT INTO `t_systemlog` VALUES ('444', 'login', 'login', '1', 'admin', '0:0:0:0:0:0:0:1', '2019-11-23 09:57:38', '0', 'y');
INSERT INTO `t_systemlog` VALUES ('445', 'login', 'login', '1', 'admin', '0:0:0:0:0:0:0:1', '2019-11-23 10:10:15', null, 'n');
